...
class Game:
    ...
    def _draw_screen(self):
        ...
        for x in range(0, int((self.horizontal_pixels*self.pixel_size)+1)):
            self.draw_pixel(self.surface, Color.white, Point(x, 0))
            for y in range(0, (self.navigation_bar_height-self.pixel_size)+1):
                self.draw_pixel(self.surface, Color.white, Point(x, y))
        ...
        solver_text = font.render(self.model.long_name + " " + self.stats, 1, Color.red)
